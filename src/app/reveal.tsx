...
export function Reveal({
  ...
  return (
    <div
      ...
      className={`transition-[transform,opacity,filter] duration-700 ease-house data-[state=hidden]:translate-y-12 data-[state=hidden]:opacity-0 data-[state=hidden]:blur-[4px] ${className}`}
    >
      {children}
    </div>
  );
