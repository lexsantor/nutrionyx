...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <span
        className={`inline-flex size-5 items-center justify-center rounded-full bg-surface-1 text-ink-subtle shadow-sm transition-transform ease-[cubic-bezier(0.32,0.72,0,1)] ${
